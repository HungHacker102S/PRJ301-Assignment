                ...
                <div>
                    ...
                    <div class="">
                        <label class="form-label">
                            <input type="radio" name="role" value="true" class="form-radio m-2" <c:if test="${user.getRole()}">checked</c:if>>
                            Admin
                        </label>
                            
                        <label class="form-label">
                            <input type="radio" name="role" value="false" class="form-radio m-2" <c:if test="${!user.getRole()}">checked</c:if>>
                            User
                        </label>
                    </div>
                    <div class="form-floating mb-3">
